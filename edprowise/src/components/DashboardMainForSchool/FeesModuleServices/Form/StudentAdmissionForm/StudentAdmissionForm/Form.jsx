              ...
              <div className="mb-3">
                ...
                {typeof formData.previousSchoolResult === "string" && (
                  <div className="text-muted small mt-1">
                    Existing file:{" "}
                    {getFileNameFromPath(formData.previousSchoolResult)}
                  </div>
                )}
        ...
        <>
          <div className="row">
            ...
            <div className="form-check ms-1 mb-2">
              ...
              />
              <label className="form-check-label" htmlFor="customCheck1">
                I Understand & agree that the registration of my word does not
                guarantee admission to the school & the registration fee is
                neither transferable not refundable.
              </label>
            </div>
