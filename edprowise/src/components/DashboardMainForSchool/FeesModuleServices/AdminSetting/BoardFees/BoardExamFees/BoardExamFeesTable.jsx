...
const BoardExamFeesList = () => {
    ...
    const fetchData = async () => {
      try {
        const feesRes = await getAPI(
          `/get-board-exam-fees/${schoolId}/${selectedYear}`,
          {},
          true
        );
  ...
  const navigateToAddNew = (event) => {
    ...
    navigate(
      `/school-dashboard/fees-module/admin-setting/board-fees/exam-fees-add`
    );
  };
                        ...
                        <td>
                          <div className="d-flex gap-2">
                            <button
                              onClick={() =>
                                navigate(
                                  "/school-dashboard/fees-module/admin-setting/board-fees/exam-fees-view",
                                  {
                                    state: { fees },
                                  }
                                )
                            ...
                            <button
                              ...
                              onClick={() =>
                                navigate(
                                  "/school-dashboard/fees-module/admin-setting/board-fees/exam-fees-update",
                                  {
                                    state: { fees },
                                  }
                                )
