...
const coursesData = [
  {
    id: 1,
    title: "Leakage of fees",
    description:
      " Through fees reconciliation, we guarantee zero leakage. Our detailed analysis identifies the gap between fees due & fees collected, enabling us to swiftly address any discrepancies.",
    classid: 1,
  },
  {
    id: 2,
  ...
  {
    id: 3,
    title: "Manual entry upon receipt of online fees",
    description:
      " Upon receipt of fees, our module automatically records the transactions in the fees software, eliminating the need for manual entry",
    classid: 3,
  },
  {
    id: 4,
